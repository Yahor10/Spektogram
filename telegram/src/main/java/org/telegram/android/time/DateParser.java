...
public interface DateParser {
     ...
     * <p/>
     * See {@link java.text.DateFormat#parse(String, java.text.ParsePosition)} for more information.
     *
     ...
     * <p/>
     * <p>
     * The default {@link java.util.TimeZone} used to create a {@link java.util.Date} when the {@link java.util.TimeZone} is not specified by
     * the format pattern.
     * </p>
     *
     ...
     * @return a <code>java.util.Date</code> object
     * @see java.text.DateFormat#parseObject(String, java.text.ParsePosition)
     */
